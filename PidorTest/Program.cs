...
namespace PidorTest
{
    class Program
    {
        ...
        {   
                ...
                "\nB: Ничто не сравниться с настоящим мужским сексом. А бытовуха - она и в Африке бытовуха."+
        ...
        static void Main(string[] args)   //Выводит вступительный текст и содержит массив вопросов и ответов
        {
            ...
            string[] IntroText = { "Wake up, Neo", "You are P.I.D.O.R", "#5^3$#$@  @! )%#1010012___!",".....Сбой вычисления характеристики P.I.D.O.R", "Необходим новый ввод данных",
